...
class Resnet38_revise(nn.Module):
    def __init__(self,num_classes=20):
        super(Resnet38_revise, self).__init__()
        ...
        self.sft1=SFTLayer(64,128)

        self.b3 = ResBlock(128, 256, 256, stride=2)
        self.b3_1 = ResBlock(256, 256, 256)
        self.b3_2 = ResBlock(256, 256, 256)
        
        self.sft2=SFTLayer(64,256)
