...
from . import ASPP
from registry import NETS,BACKBONES
...
class deeplabv3plus(nn.Module):
	def __init__(self, backbone=backbone, batchnorm=nn.BatchNorm2d, **kwargs):
		super(deeplabv3plus, self).__init__()
		self.cfg = cfg
		self.batchnorm = batchnorm
		self.backbone = build_backbone(backbone=backbone, pretrained=cfg.MODEL_BACKBONE_PRETRAIN, norm_layer=self.batchnorm, **kwargs)
